...
<img src="https://github.com/DeepLabCut/DeepLabCut/assets/28102185/1752962e-fb10-4ef5-b0bf-244be9d6f512" width="29%" alt="Benchmark table">
<img src="images/openfield_benchmark_pr2613.png" width="69%" alt="Openfield benchmark results">
Pose estimation performance of the 3.0 PyTorch models compared against previous TensorFlow models on the DeepLabCut Openfield dataset; RMSE: root mean squared error (see PR [#2613](https://github.com/DeepLabCut/DeepLabCut/pull/2613) for the full data table).

<img src="https://images.squarespace-cdn.com/content/v1/57f6d51c9f74566f55ecf271/1619609897110-TKSTWKEM6HTGXID9D489/triMouseDLC.gif" width="29%">
<img src="images/speed_tensorflow.avif" alt="Speed comparison: PyTorch vs TensorFlow" width="69%">
